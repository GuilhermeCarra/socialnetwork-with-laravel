...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-09-2020 a las 00:54:13
...
(4, '2020_09_21_142544_create_posts_table', 1),
(5, '2020_09_21_150206_create_comments_table', 1),
(6, '2020_09_21_154354_create_follows_table', 1),
(7, '2020_09_21_193822_create_reactions_table', 1);
...
ALTER TABLE `follows`
  ...
  ADD KEY `follows_user_2_foreign` (`user_2`);
...
--
ALTER TABLE `follows`
  ADD CONSTRAINT `follows_user_1_foreign` FOREIGN KEY (`user_1`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `follows_user_2_foreign` FOREIGN KEY (`user_2`) REFERENCES `users` (`id`);
